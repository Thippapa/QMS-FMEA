...
def requirement_list(request):
    if is_demo_mode():
        documents = [
            {
                "RequirementRefName": "Customer Specific Requirement",
                "DetailRequirementRef": "IATF 16949 / Customer CSR for FMEA and Control Plan",
                "ResponsibleName": "Quality Engineer",
                "RevisionNumber": 3,
                "OriginatedDate": "2026-01-10",
                "RevisionDate": "2026-05-01",

                # เผื่อ template ใช้ชื่อ field แบบอื่น
                "DocumentName": "Customer Specific Requirement",
                "Description1": "IATF 16949 / Customer CSR for FMEA and Control Plan",
                "Description2": "FMEA and Control Plan requirement reference",
                "PrepareBy": "Quality Team",
                "DocModifiedDate": "2026-05-01",
            },
            {
                "RequirementRefName": "Process Control Standard",
                "DetailRequirementRef": "Internal standard for process control and reaction plan",
                "ResponsibleName": "Process Engineer",
                "RevisionNumber": 2,
                "OriginatedDate": "2026-02-15",
                "RevisionDate": "2026-04-20",

                # เผื่อ template ใช้ชื่อ field แบบอื่น
                "DocumentName": "Process Control Standard",
                "Description1": "Internal standard for process control and reaction plan",
                "Description2": "Process control and inspection standard",
                "PrepareBy": "Process Team",
                "DocModifiedDate": "2026-04-20",
            },
        ]
...
def approve_dashboard(request):
    if is_demo_mode():
        approvals = [
            ...
            {
                "DocumentID": 3,
                "DocumentName": "Control Plan - Assembly",
                "StatusName": "Approval Rejected",
                "ApprovalRequestDate": "2026-05-03",
                "ResponsibleuserID": 103,
                "ResponsibleName": "Engineer C",
                "ApprovalGroupUserID": 203,
                "LoggedInName": "Approver C",
                "ApprovalActionTakenDate": "2026-05-04",
                "RevisionNumber": 1,
                "ApproverNotes": "Revise inspection frequency",
            },
        ]
    else:
        with connection.cursor() as cursor:
    ...
    if is_demo_mode():
        cp_records = [
            ...
            },
            {
                ...
                "Number": "PC-003",
                "Product": "Appearance",
                "Process": "Final quality gate",
                "SPEC": "No scratch / no deformation",
                "Measurement": "Visual Inspection",
                "SampleSize": "100%",
                "FREQ": "Every lot",
                "ControlMethod": "Final inspection checklist",
                "ReactionPlan": "Hold shipment and issue NCR",
                "Description1": "Final Inspection FMEA",
            },
        ]
    else:
        with connection.cursor() as cursor:
